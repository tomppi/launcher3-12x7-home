 ...
 * All-apps fields, folder fields, hotseat fields, widget metadata, foldable page behavior, and
 * search fields are deliberately untouched.
 */
public final class LauncherGridHook implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
                ...
                new XC_MethodHook() {
                    ...
                    protected void beforeHookedMethod(MethodHookParam param) {
                        try {
                            ...
                            // Change only the workspace grid before Launcher3 copies it to the active
                            // profile. All Apps and all widget behavior remain stock.
                            ...
                            if (!appliedLogWritten) {
                                ...
                                XposedBridge.log(TAG + ": applied stable 7 columns x 12 rows; app drawer and widgets untouched");
                            }
                        } catch (Throwable error) {
        ...
        if (hooks == null || hooks.isEmpty()) {
            ...
            XposedBridge.log(TAG + ": stable grid-only hook installed for " + TARGET_PACKAGE);
        }
    }
